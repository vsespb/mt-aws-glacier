...

{
	...
	is_deeply($result, {key=>'mykey', secret => 'mysecret', region => 'myregion', vault=>'myvault', config=>'glacier.cfg', journal => 'journal.log', 'max-number-of-files' => 10}, 'v0.78 regressiong in restore');
	is_deeply($warnings, ['to-vault deprecated, use vault instead','from-dir is not needed for this command'], 'v0.78 regressiong in restore');
}
